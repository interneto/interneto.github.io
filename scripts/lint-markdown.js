...
const DOCS_DIR = path.resolve(__dirname, '../src/content/categories')
...
files.forEach((file) => {
  ...
  // These are hand-authored pages in the categories dir, not generated by convert.js.
  const FILES_TO_IGNORE = [
    'src/content/categories/index.md',
    'src/content/categories/about.md',
    'src/content/categories/nsfw.md',
    'src/content/categories/nsfw-content.md'
  ]
