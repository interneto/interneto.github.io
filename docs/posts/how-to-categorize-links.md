...
For most people [Raindrop.io](https://raindrop.io) is the quickest way to apply these ideas: it has fast search, smart tags, and great browser extensions. If you prefer to self-host, [Linkwarden](https://github.com/linkwarden/linkwarden) gives you folders, tags, and saved snapshots without relying on a cloud service.
